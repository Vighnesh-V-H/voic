  ...
  "group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        ...
        success:
          "border-pastel-green-border bg-pastel-green-bg text-pastel-green-text text-[11px] tracking-[0.05em] uppercase",
        info: "border-pastel-blue-border bg-pastel-blue-bg text-pastel-blue-text text-[11px] tracking-[0.05em] uppercase",
        warning:
          "border-pastel-yellow-border bg-pastel-yellow-bg text-pastel-yellow-text text-[11px] tracking-[0.05em] uppercase",
        error:
          "border-pastel-red-border bg-pastel-red-bg text-pastel-red-text text-[11px] tracking-[0.05em] uppercase",
      },
    },
    defaultVariants: {
      variant: "default",
